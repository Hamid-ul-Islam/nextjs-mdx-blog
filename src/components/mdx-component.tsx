...
const components = {
	h1: ({ className, ...props }: ComponentsProps) => (
		<h1
			className={cn(
				'mt-7 scroll-m-20 text-4xl font-bold text-primary tracking-tight',
				className,
			)}
			{...props}
		/>
	...
	h2: ({ className, ...props }: ComponentsProps) => (
		<h2
			className={cn(
				'mt-20 scroll-m-20 border-b pb-1 text-3xl font-semibold text-primary tracking-tight first:mt-0',
				className,
			)}
			{...props}
		/>
